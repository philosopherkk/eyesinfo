...
export const TOOL_TEXT: L<Record<ToolId, { title: string; blurb: string; canto: string }>> = {
  "zh-Hant": {
    ...
    drops: { title: "點藥步驟", blurb: "洗手、唔好掂睫毛、按淚點", canto: "跟住步驟點" },
    ...
    warm: { title: "熱敷計時", blurb: "8–10 分鐘，暖唔好燙", canto: "熱敷跟時間" },
  ...
  "zh-Hans": {
    ...
    drops: { title: "点药步骤", blurb: "洗手、不要碰到睫毛、按泪点", canto: "跟着步骤点" },
    ...
    warm: { title: "热敷计时", blurb: "8–10 分钟，暖不要烫", canto: "热敷跟时间" },
  ...
  en: {
    ...
    drops: { title: "Drop technique", blurb: "Wash hands, miss the lashes, press the punctum", canto: "Follow the steps" },
    ...
    warm: { title: "Warm compress timer", blurb: "8–10 minutes, warm not hot", canto: "Time the compress" },
  ...
  ja: {
    ...
    drops: { title: "点眼の手順", blurb: "手洗い、睫毛に触れない、涙点圧迫", canto: "手順どおりに" },
