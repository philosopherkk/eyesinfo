...
export const EN_PACKS: Record<string, TopicPack> = {
  ...
  "t-ted": {
    ...
    blocks: [
      h("What it is"),
      p("Thyroid eye disease (thyroid-associated orbitopathy) is autoimmune orbital disease. Stimulatory antibodies (TRAb) can cross-activate TSH receptors and IGF-1 receptors on orbital fibroblasts, expanding glycosaminoglycan, fat and extraocular muscle — hence proptosis, limited motility, diplopia and, when severe, apical crowding. Endocrinology and ophthalmology share care. This page is education, not self-diagnosis or a prescription."),
      ...
      ol([
        "Supportive care: lubrication and surface protection, head elevation, prisms for selected diplopia; stopping smoking (including second-hand smoke) is among the most important modifiable factors",
        "Selected mild active cases: a doctor may discuss whether selenium is appropriate — a specialty decision; this page has no public dose schedule",
      ...
      w("Dysthyroid optic neuropathy (DON): vision drop, colour desaturation, RAPD, field defect, disc swelling, apical crowding — treat as threatened sight and go to A&E now. Do not wait for thyroid bloods to “settle” first."),
  ...
  "t-strabsx": {
    ...
    blocks: [
      ...
      ul([
        ...
        "Adjustable sutures are an adult option some surgeons use; use is decided at surgery",
        "No public millimetre-per-prism-dioptre dosing tables (operator protocol, not education)",
      ]),
      h("After surgery"),
      p("Redness and discomfort are often expected. Antibiotic drops (e.g. chloramphenicol or fusidic acid class) and steroid drops (e.g. fluorometholone or dexamethasone class) are prescribed by the operating surgeon. This page has no default “times a day × weeks” public recipe and lists no brand names."),
      w("Sudden severe pain, rapid vision drop, copious pus, corneal haze or fever after surgery: exclude infection or anterior-segment ischaemia — go to A&E / urgent eye care now. Infection is uncommon but sight-threatening. Do not add leftover steroid drops on your own."),
  ...
  "t-scleritis": {
    ...
    blocks: [
      ...
      w("Necrotising scleritis, or posterior scleritis with threatened vision or severe boring pain: do not park this as “wait for clinic”. Sudden vision drop or sudden blindness, or severe pain with headache and vomiting: go to A&E now. Other severe eye pain with vision drop: A&E now or same-day urgent eye care — do not self-label as conjunctivitis."),
