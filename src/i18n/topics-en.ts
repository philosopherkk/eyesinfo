...
export const EN_PACKS: Record<string, TopicPack> = {
  ...
  d4: {
    ...
    blocks: [
      ...
      p("The angle is open; outflow resistance is high; pressure is often raised. Early disease is silent. Age, family history, high myopia and a thin cornea raise risk. A doctor may discuss pressure-lowering drops, selective laser trabeculoplasty (SLT; the LiGHT trial supports SLT as one first-line option for suitable people — not mandatory for everyone, and not a personal guarantee), then surgery classes if drops or laser are not enough or not tolerated. Monitoring needs pressure, field and OCT — not a single pressure reading."),
      ...
      p("The iris blocks access to the trabecular meshwork. Hyperopia, a shallow chamber, an ageing lens and Chinese ancestry are associated. Stages such as suspect closure, angle closure and angle-closure glaucoma are research and teaching labels — not for self-diagnosis. Chronic closure can be painless, with repeated pressure rises and slow field loss."),
      p("Public research linked to Zhongshan Ophthalmic Center helps frame how common “narrow angles” are in Chinese populations — not your personal risk, and not a clinic outcome guarantee. In the Guangzhou Liwan Eye Study (Zhongshan team), among urban Chinese aged ≥50 with open angles at baseline, about one in five developed some form of primary angle closure over ten years (any stage cumulative about 20.5%; most were suspect closure / PACS, with lower numbers progressing to angle-closure glaucoma / PACG). A thicker lens, shallower anterior chamber and narrower angles were associated with higher incidence. In the Zhongshan Angle-Closure Prevention (ZAP) Trial, community-screened people with bilateral primary angle-closure suspect (PACS) status received laser peripheral iridotomy (LPI) in one eye with the fellow eye as control: LPI reduced later progression to angle-closure–related endpoints, but overall progression and acute attacks remained relatively uncommon in that community PACS group — whether to offer preventive laser is an individual risk decision by a doctor; this page does not guarantee that everyone must or must not have it."),
      w("Acute angle-closure attack: pressure can rise to tens of mmHg — red painful eye, headache, nausea or vomiting, rainbows around lights, a sharp vision drop, steamy cornea, a mid-dilated fixed pupil. Untreated hours can permanently damage the nerve. Go to A&E now. If you cannot get there: call 999. Do not put in dilating drops yourself, do not tough it out in a dark room, and do not wait for a private clinic to open. The other eye may be narrow too; after emergency care a doctor may offer preventive laser iridotomy in the fellow eye."),
      h("Dilating drops and medicines: why they may trigger an acute attack (education, not a prescription)"),
      p("When the pupil is mid-dilated, peripheral iris can block aqueous outflow (pupillary block); in an already narrow or shallow front of the eye this can precipitate acute angle closure. People at higher risk are usually those with known narrow angles or angle-closure history, hyperopia / a shallow chamber, and older Chinese adults (especially women) — these are population and anatomy ballparks, not personal probability guarantees."),
      p("Topical dilating drops (for eye exams): clinics commonly use short-acting mydriatic drops to dilate the pupil for a fundus exam. Most people are fine; if you already know you have narrow angles, had an acute attack, or were told “do not dilate,” tell the examiner before dilation. Do not buy dilating drops yourself to “clear the eyes.”"),
      p("Systemic / over-the-counter medicines: some cold or cough remedies, antihistamines, anticholinergic or sympathomimetic ingredients, and some psychiatric or anti-Parkinson medicines can dilate the pupil or shift the ciliary body and precipitate an attack (mechanism summarised in medication-induced angle-closure reviews; this page lists no brand names). A Hong Kong prospective series reported that some people with acute primary angle closure had a recent upper respiratory infection or had taken cough medicine — an observation from that study, not that a cold always causes an attack, and not a brand comparison. If you have a narrow-angle history: tell the doctor or pharmacist before getting medicines; if you get a red painful eye, rainbows, nausea or vomiting, or a sudden vision drop → A&E / 999 now; do not add more dilating drops or “wait one more night.”"),
      p("Staying in the dark for long periods or emotional arousal can also dilate the pupil — the same physiological pathway as education on triggers, not a claim that turning off the lights will inevitably cause an attack."),
      ul([
        "A&E may use several pressure-lowering routes (topical drops, oral or intravenous carbonic-anhydrase inhibitors, hyperosmotic agents) chosen by the duty doctor for the kidneys and allergy history",
        "Laser iridotomy when the cornea clears; later early lens extraction only in selected people — EAGLE had strict entry criteria (see the hyperopia / shallow-chamber page); not for every narrow angle",
      ]),
      h("Three care directions a doctor may discuss (education overview, not a prescription)"),
      p("Glaucoma care usually centres on three paths that can be used alone or in sequence. Which fits depends on type (open-angle / angle-closure / normal-tension and so on), target pressure, field and nerve change, side effects, and whether drops can be taken on schedule — only an ophthalmologist decides. This page does not rank “which is best” or quote any clinic’s success rate."),
      ul([
        "Pressure-lowering drops (long-term medicine): the long-term backbone for most open-angle disease and ocular hypertension. Taking them on time and reducing missed doses is one improvable reason for worsening. Mechanisms, cautions and technique for five topical classes are on the glaucoma drops page. No product names here. Do not stop on your own or lend leftover bottles.",
        "Laser: for open-angle / ocular hypertension, selective laser trabeculoplasty (SLT) and similar — the LiGHT randomised trial (Gazzard et al., Lancet 2019) supports SLT as one first-line option for suitable people; a later six-year visual-field progression analysis (Montesano et al.) also found slower average field worsening in the SLT-first group. Those figures are from public trials / analyses — not your personal prognosis, not a brand comparison, and not something everyone must have; field already lost cannot be restored. Whether it fits and whether drops can be reduced is the doctor’s call. For angle-closure–related care, laser peripheral iridotomy (LPI) and similar — see the angle-closure / ZAP education above; preventive laser is not “everyone must” or “everyone must not.” Drops or further surgery may still be needed after laser.",
        "Surgery (more often discussed when drops / laser are not enough or not tolerated): conceptually includes traditional filtering surgery (e.g. trabeculectomy-class), aqueous drainage devices, and several minimally invasive glaucoma surgery (MIGS) classes — indications, risks and aftercare differ widely. The aim is still to lower pressure to slow worsening; lost field does not return. This page quotes no success rates, lists no device or implant brand names, and has no DIY postoperative drop timetable.",
      ]),
      p("Personalised target pressure and how to read OCT / visual-field reports: see the glaucoma-monitoring hub (target IOP, OCT / visual field and reports)."),
  ...
  d7: {
    ...
    blocks: [
      ...
      h("Infectious"),
      p("Viral disease is often watery and spreads readily by hand–eye contact and shared towels (public-health education in the spirit of CDC / AAO guidance). Bacterial discharge tends to be stickier. In adults with sexually transmitted infection risk, a doctor may educate about and work up chlamydia- or gonococcus-associated conjunctivitis (public references such as the MSD Manual) — not a DIY purchase. Do not self-buy steroid eye drops."),
      h("Allergic (including VKC / AKC)"),
      p("Itch is usually prominent. Vernal keratoconjunctivitis (VKC) and atopic keratoconjunctivitis (AKC) are heavier chronic allergy and can risk shield ulcer — not ordinary red eye; do not self-buy steroids. Drug classes and principles: allergic-conjunctivitis treatment page; Hong Kong environment triggers: allergy and the Hong Kong environment page."),
      h("Medication-related"),
      p("Benzalkonium chloride (BAK), a common preservative in multi-dose drops, can irritate the ocular surface (Goldstein et al., Eye 2022). Long-term topical therapy (especially glaucoma drops) is also discussed in the literature as drug-induced cicatrizing / pseudopemphigoid-like conjunctivitis (Singh et al., Ocul Surf 2022) — for ophthalmologist assessment, not a DIY stop-or-swap handbook."),
      h("When it is urgent"),
  ...
  "t-myopia": {
    ...
    blocks: [
      ...
      h("Childhood myopia in Hong Kong: before and after pandemic restrictions (education)"),
      p("Hong Kong Children Eye Study repeated cross-sectional data (JAMA Network Open 2023): among children aged 6–8, myopia prevalence stayed about 23.5–24.9% in 2015–2019, rose to about 28.8% in 2020 (during restrictions), and about 36.2% in 2021 (after easing) — not your child’s personal odds, and not a brand comparison. Outdoor time fell versus pre-pandemic levels while near work / screen time rose; younger children and those from lower-income families had higher risk during restrictions (study observations). After easing, habits had not fully returned to pre-pandemic patterns — supporting continued attention to outdoor time and near-work hygiene, not a promise of slower progression."),
      ...
      h("LAMP2: children not yet myopic (incidence — not control of existing degree)"),
      p("The same Hong Kong team’s LAMP2 randomised trial (JAMA 2023): children aged 4–9 who were not yet myopic by cycloplegic criteria used night-time low-concentration atropine for two years. Two-year cumulative myopia incidence: about 28.4% with 0.05%, about 45.9% with 0.01%, and about 53.0% with placebo; fast myopic shift was also lower in the 0.05% group. 0.01% did not differ significantly from placebo on that endpoint. These are trial results — not a personal prescription, not a ranking of which concentration is “best”, and not a cross-brand league table. Concentration, whether to use, and when to stop must be decided by a registered doctor after examination; parents must not dilute drops or buy unofficial preparations. Photophobia and other effects: see the paragraph above."),
  ...
  "t-cataract": {
    ...
    blocks: [
      ...
      h("Do you have to wait until it is “ripe”? (a common myth)"),
      p("In public education, “wait until the cataract is fully ripe / the eye is completely cloudy before surgery” is mostly an older idea, not a general rule in the phaco era. More usual discussion points are whether the cataract already limits reading, driving, night glare, work or fall risk; whether it blocks monitoring of diabetic eye disease or macular disease; and whether a thickening lens adds to narrow-angle risk — decided only after an ophthalmologist examines you. This page does not say “everyone must operate now” or “everyone must wait longer.”"),
      p("When a lens is hypermature, extremely hard, or the zonules are unstable, surgery can be harder and some complication risks can rise (an education concept, not your personal odds). “Waiting until it is too ripe” is not necessarily safer; conversely, if vision is still adequate and daily life is unhindered, that does not mean surgery must happen immediately. Whether and when to operate is not an advertising timetable."),
      ...
      ol([
        ...
        "Clear-corneal main incision about 2.2–2.7 mm plus a side port; often no suture",
        ...
        "Ultrasound emulsifies the nucleus into small fragments and aspirates them",
        "Femtosecond laser–assisted cataract surgery (FLACS) is another option: laser may assist capsulorrhexis, nucleus fragmentation or incisions, then phaco usually still removes the nucleus. Not everyone needs it. FACT (Day et al., Ophthalmology 2020) was a randomised noninferiority trial: primary vision outcomes versus standard phaco did not show a clinical advantage that would justify writing femto as a “standard upgrade.” FEMCAT (Schweitzer et al., Lancet 2020) was a multicentre randomised trial: superiority was not met, and cost-effectiveness did not support routine universal use. Those are named-trial results — not your personal prognosis, not a clinic or device-brand comparison, and not an advert that femto is “safer / always better.”",
        "Aspiration of remaining cortex",
      ...
      ul([
        ...
        "Negative dysphotopsia (a temporal shadow): seen in early literature; most ease over weeks to months",
  ...
  "t-dry": {
    ...
    blocks: [
      ...
      h("Why drops again and again still feel inadequate (education, not self-diagnosis)"),
      p(
        "Artificial tears / lubricants mainly ease dryness and intermittent blur; they usually cannot cure meibomian gland dysfunction or Sjögren syndrome (see lubricants and ocular-surface lubricants). If frequent watery lubrication alone helps little, a doctor may rethink:",
      ),
      ul([
        "Whether evaporative disease / meibomian gland dysfunction dominates — warm compresses and lid hygiene matter; “two more drops” alone is often not enough",
        "Whether ocular-surface inflammation is also present — prescription anti-inflammatories (e.g. cyclosporine class) need a doctor’s prescription and take time; short-course steroids only under intraocular-pressure monitoring",
        "Whether the form is a poor match (preservative-free, more viscous, night ointment) — see the lubricant topic; no product names here",
        "Whether it is not plain dry eye at all (infection, an allergic flare, contact-lens–related keratitis, uveitis / scleritis, acute angle closure, and so on)",
      ]),
      p(
        "“Drops never help” is not a diagnosis; tear film, lid margin and ocular surface need examination before the next step. This ladder is an international consensus framework, not a shopping list.",
      ),
      h("Categories a doctor may discuss by severity"),
      ul([
        "Lubrication: preservative-free artificial tears (hyaluronic acid, carboxymethylcellulose, HP-Guar and similar classes); warm compresses; less screen time; humidify. Forms, preservatives, expectations and limits: lubricants and ocular-surface lubricants; warm-compress steps: warm compress and lid massage",
        "Night gel or ointment; dietary omega-3: the DREAM randomised trial (Asbell et al. / DREAM Study, NEJM 2018) in people with moderate-to-worse symptoms did not show superiority of n-3 fatty-acid supplements over placebo for the primary symptom outcome — individual; not a medicine advertisement for treating eye disease, and not a brand comparison",
  ...
  "t-glaucoma-monitor": {
    ...
    blocks: [
      ...
      h("Target IOP (teaching)"),
      note("Target IOP is set individually by the treating clinician from optic-nerve structure, visual-field function and speed of change — it is not your prescription target, and you should not self-match to a table."),
      p("Literature often discusses relative pressure drops: normal-tension glaucoma (CNTGS) commonly discusses a further drop of about 30%; ocular hypertension (OHTS) commonly discusses about 20%. Actual millimetre-of-mercury targets and percentage drops are decided only by an ophthalmologist; this page is not a visit."),
      p("Educational factors that may shape a target (a list, not a DIY score): optic-nerve damage, visual field, speed of change, age, thin cornea, disc haemorrhage, family history."),
  ...
  "t-cl": {
    ...
    blocks: [
      ...
      ol([
        ...
        "Discard used solution — do not save money by leaving old solution in the case and adding fresh on top; replace the case about every three months and air-dry it",
      ...
      p("Acanthamoeba is widespread in environmental water (including tap-water systems). With a contact lens on, water can trap organisms between lens and cornea and raise Acanthamoeba keratitis (AK) risk. AK is uncommon but can be severely painful, hard to treat and sight-threatening — typical features are in the serious-complications table. This section covers care principles only: it does not rank which solution “kills Acanthamoeba best”, and it does not promise that switching to daily disposables means you will never get AK."),
      {
        ...
        rows: [
          ...
          [
            "Leave old solution in the case and add fresh on top; leave the case where bathroom splash hits it",
      ...
      h("Common myths (hygiene)"),
      {
        ...
        rows: [
          ...
          [
            ...
            "Dump used solution; do not leave old solution and add fresh on top.",
          ],
          [
  ...
  "t-optic-neuritis": {
    ...
    blocks: [
      ...
      p("Public-education points:"),
      ul([
        "Causes may be infection-related (relatively uncommon) or non-infectious / immune-related (more often discussed).",
        "“Typical” demyelinating optic neuritis and links to central demyelinating disease (including multiple sclerosis) belong in specialist assessment; in Asian populations other antibody-related optic neuritis spectra (e.g. anti-AQP4 / anti-MOG) are also discussed — whether blood tests are done, and which type applies, is not a self-label exercise.",
        "This page covers classes and principles only — no clinic comparison and no personal cure rates.",
      ]),
      h("Common symptoms (education, not a diagnostic checklist)"),
      ul([
        "Blurred or sudden monocular vision loss",
        "Pain on eye movement",
        "Reduced colour saturation; vision looking grey",
        "Visual-field defects (central or other patterns)",
        "A relatively sluggish pupil light response (examined by a doctor)",
      ]),
      h("Go to A&E now (if you cannot get there, call 999)"),
      ul([
        "Severe headache, vomiting, limb weakness, diplopia, altered consciousness or other neurological signs → A&E / 999",
      ]),
      h("Same-day ophthalmic assessment when possible"),
      ul([
        "Sudden monocular or binocular vision drop, clearly washed-out colours, or severe pain on eye movement — see an ophthalmologist promptly",
      ]),
      p("Clinic follow-up follows the doctor’s plan; once a type is diagnosed, review timing is set by the specialty team."),
      h("What a doctor may discuss / arrange (concepts)"),
      ul([
        "Vision, colour vision, visual fields, relative afferent pupillary defect",
        "Fundus exam; OCT of optic-nerve fibre / macular structure when needed",
        "MRI of the optic nerve and brain when clinically indicated",
        "Blood tests (infection markers, specific autoantibodies — case by case)",
        "Whether neurology / neuro-ophthalmology co-management is needed",
      ]),
      p("Treatment classes (not a prescription): for some acute optic neuritis, a doctor may discuss short-course high-dose corticosteroids to speed visual recovery. The large randomised Optic Neuritis Treatment Trial (ONTT) suggested that, in that trial setting, intravenous then oral steroids accelerated recovery; lower-dose oral-only regimens were not the approach supported by that trial; final vision differences must be read as trial results, not a guarantee for you. Other types (e.g. some antibody-related optic neuritis) may follow different strategies — only a doctor decides. No trade names; no booking, prescribing or purchasing on this site."),
      h("Common misconceptions"),
      {
        type: "table",
        rows: [
          ["Misconception", "Closer wording"],
          ["“Eye strain equals optic neuritis”", "Most eye strain improves with rest; vision / colour / movement-pain changes need optic neuritis and related causes ruled out."],
          ["“It must be multiple sclerosis”", "Optic neuritis has many causes; MS risk is stratified by imaging and clinical features — not the same for everyone."],
          ["“Steroids guarantee full recovery”", "Many people improve a lot, but colour / contrast can stay altered long term — not a cure promise."],
          ["“Asian patients always need long-term immunosuppression”", "Long-term immune modulation is an individualised specialty decision; this page gives no recipes."],
        ],
      },
      note("Public education only — not personal prognosis; does not replace a registered ophthalmology / neurology visit. No booking, prescribing or purchasing. For emergencies go to A&E / call 999."),
    ],
  },
  ...
  "t-corneal-transplant": {
    ...
    blocks: [
      ...
      ul([
        "Full-thickness (penetrating keratoplasty, PK): replaces the full corneal thickness.",
        "Lamellar / partial-thickness: replaces only some layers — e.g. anterior lamellar (stroma / front-surface problems) or endothelial / posterior lamellar (endothelial failure).",
      ]),
      p("Which type fits depends on which layers are diseased, scarring, infection history, pressure and the whole eye — only a corneal specialist can decide. This page does not rank “which is best” or clinic success rates."),
      h("Why aftercare matters (education, not a guarantee)"),
      p("Donor tissue is foreign to the body; the immune system may mount rejection. The cornea’s relative “immune privilege” means rejection risk varies by person and disease state — but is never zero. Aftercare commonly includes:"),
      ul([
        "Protecting the eye; avoid trauma and forceful rubbing",
        "Anti-inflammatory / anti-rejection drops as directed (classes only; no trade names)",
        "Timely review for infection, pressure, sutures and graft clarity",
      ]),
      p("Over years, donor endothelial cell density falls; some grafts later cloud from endothelial failure, rejection, infection or disease recurrence — whether to reoperate is individual."),
      h("RSVP warning signs (seek care promptly)"),
      p("The English RSVP mnemonic is used for self-watching after surgery (education):"),
      ul([
        "Redness",
      ...
      p("If one or more appear, do not escalate drop doses yourself — contact the operating doctor promptly or go to A&E. Rejection, infection, suture problems and raised pressure can look similar."),
      h("Go to A&E now (if you cannot get there, call 999)"),
      ul(["Severe pain, heavy discharge or sudden vision drop → A&E / 999"]),
      h("What a doctor may discuss"),
      ul([
        "Indications: advanced keratoconus, scar, endothelial decompensation, post-infection opacity and similar (individualised)",
        "Surgery type (full-thickness vs lamellar), sutures, gas / tamponade when relevant",
        "Post-op drop plans, pressure monitoring, steroid-related cataract / glaucoma risk (class education)",
        "How rejection is recognised and managed in principle (intensified anti-inflammatory care — by the doctor)",
        "Possibility of re-graft and the usual rise in risk with repeat grafts (see registry literature)",
      ]),
      h("Common misconceptions"),
      {
        type: "table",
        rows: [
          ["Misconception", "Closer wording"],
          ["“Good aftercare guarantees success”", "Aftercare matters, but original disease, vascularisation, prior rejection and surgery type also matter."],
          ["“Corneal grafts never reject”", "Rejection can occur at any postoperative time; long-term vigilance is needed."],
          ["“Lamellar equals zero rejection”", "Some lamellar approaches can lower certain rejection risks — not a guarantee."],
          ["“Failure means it can never be redone”", "Re-graft is possible, but risk often rises with repeats; individual assessment."],
          ["“Everyone has the same high success rate”", "Registry survival curves vary widely by indication — not personal prognosis."],
        ],
      },
      note("Public education only — not personal prognosis; does not replace a face-to-face visit. No booking, prescribing or purchasing. Postoperative emergencies: A&E / 999. Related reading may include the keratoconus page; this page makes no success-rate comparisons."),
    ],
  },
  ...
  "t-nystagmus": {
    ...
    blocks: [
      ...
      ul([
        "Start in early life (often called infantile / congenital nystagmus syndrome spectra)",
        "Or appear later (acquired), when neurological, vestibular, drug / toxin or visual-pathway causes need more active exclusion",
      ]),
      p("Some infantile forms link to sensory visual disorders (e.g. albinism, retinal / optic-nerve developmental problems, congenital cataract); others are called idiopathic after work-up. Classification and naming have been updated over years (including CEMAS-oriented syndrome labels) — the public need not self-label."),
      h("Types (coarse education split)"),
      ol([
        "Infantile onset (often noticed in the first months of life): idiopathic or with sensory-system anomalies; some children have little sense that the world is shaking (little oscillopsia), so family may notice eye movements or abnormal head posture first",
        "Fusion-development–related / latent nystagmus: may relate to childhood strabismus; direction change when one eye is covered is examined by a doctor",
        "Acquired: may relate to peripheral vestibular problems, central nervous system disease, drugs, metabolism and similar; oscillopsia, vertigo, poor balance and diplopia are more common companions",
      ]),
      h("Go to A&E now (if you cannot get there, call 999)"),
      ul([
        "New nystagmus (especially in older children or adults) that is asymmetric / mainly unilateral, or with diplopia, severe vertigo, vomiting, unsteady gait, limb weakness, severe headache or altered consciousness → A&E / 999",
      ]),
      h("Same-day ophthalmic assessment when possible"),
      ul([
        "New nystagmus without the emergency red flags above — see an ophthalmologist promptly",
        "Infants with new nystagmus plus strabismus, leukocoria or very poor vision → prompt paediatric ophthalmology (other intraocular disease must also be excluded)",
      ]),
      p("Known stable infantile nystagmus without new neurological signs is followed in clinic for optical correction, amblyopia risk and whether surgery is discussed."),
      h("What a doctor may discuss / arrange"),
      ul([
        "Vision, refraction, colour / stereo (age-appropriate)",
        "Direction and intensity of nystagmus, null zone, abnormal head posture, strabismus",
        "Slit-lamp and fundus exam to exclude clear media or retinal / optic-nerve structural problems",
        "When needed: electrophysiology, genetic counselling, neurology review, imaging or vestibular testing",
        "Optics: correct refractive error; occasionally prisms to improve head posture (individualised)",
        "Surgery classes: for marked abnormal head posture, extraocular-muscle surgery may be discussed to shift the null zone toward primary position (functional goals below)",
        "Medicine classes: for acquired forms or severe oscillopsia, specialists may discuss drug options — no trade names and no prescribing on this page",
      ]),
      p("For infantile nystagmus, surgery discussions in the literature mainly centre on functional goals such as improving abnormal head posture / finding a quieter direction of gaze (null zone / head posture) — not a guarantee of “curing” nystagmus or bringing vision to normal. Conclusions from published reviews and society assessments are not your personal prognosis and not a brand comparison."),
      h("Common misconceptions"),
      {
        type: "table",
        rows: [
          ["Misconception", "Closer wording"],
          ["“Nystagmus always means a brain tumour”", "Most infantile forms are not tumours; new acquired nystagmus still needs central causes taken seriously."],
          ["“Children’s nystagmus can be ignored”", "Sensory causes and amblyopia risk need exclusion — ophthalmic assessment is appropriate."],
          ["“Surgery always cures it”", "Surgery often improves head posture; the waveform may remain; results vary. Not a guarantee of curing nystagmus."],
          ["“A short course of medicine always fixes it”", "Some vestibular problems improve, but timing and whether medicine is used are doctor decisions — not a guarantee."],
        ],
      },
      note("Public education only — not personal prognosis; does not replace a face-to-face visit. No booking, prescribing or purchasing. Emergencies: A&E / 999. Structural cross-links may include strabismus / child-vision pages; this page does not re-sell amblyopia treatment."),
    ],
  },
  ...
  "t-ocular-tumours": {
    ...
    blocks: [
      ...
      ol([
        "Eyelid and ocular surface: e.g. eyelid lumps; malignant ones may enlarge progressively, ulcerate, bleed or cause local lash loss — get checked; do not self-label as a stye.",
        "Orbit (tissues around the globe): may limit eye movements (diplopia), cause proptosis or compress the optic nerve (field / vision change).",
        "Intraocular: in adults, uveal melanoma (including choroidal) is a commonly discussed primary malignancy; in children, retinoblastoma is a key education theme. Small intraocular lesions can be asymptomatic early, so this page is not for fearful self-scanning; new floaters, flashes, distortion, field loss or childhood warning signs warrant care.",
      ]),
      p("This page is classification and care-path education only — no clinic comparison and no personal survival guarantees."),
      h("Adults: uveal / choroidal melanoma (education)"),
      p("Uveal melanoma is among the most discussed primary intraocular malignancies in adults. Diagnosis rests mainly on clinical exam and imaging (ultrasound and similar). Treatment concepts may include plaque / brachytherapy, enucleation and other specialty strategies. The large multicentre randomised Collaborative Ocular Melanoma Study (COMS), in eligible medium-sized choroidal melanomas, compared iodine-125 brachytherapy with enucleation: overall survival did not show one clearly better than the other in that trial population — those are trial-group results, not your personal prognosis, and not a brand / centre comparison. Whether eye-sparing radiation is suitable can only be decided by an ocular oncology team."),
      h("Children: retinoblastoma (education)"),
      p("Retinoblastoma is one of the most important intraocular malignancy education themes in young children and relates to RB1 and related pathways; some cases are hereditary / germline and some are not — it can occur with or without family history; whether genetic testing is done is decided by specialty / genetic counselling."),
      p("Soft warning signs for carers (not self-diagnosis):"),
      ul([
        "Leukocoria on flash photos (asymmetric red reflex)",
        "New or progressive strabismus",
        "Clearly worse visual behaviour, or a red painful eye (more often later)",
      ]),
      p("If these appear → prompt paediatric ophthalmology / dilated eye exam. Public education on treatment priorities often stresses life first, then eye salvage, then vision — local therapies (laser / cryotherapy classes), systemic or local chemotherapy pathways, radiation or enucleation are decided only by a paediatric ocular oncology team. This page does not promise that “early care always saves the eye / always cures”."),
      h("Go to A&E now (if you cannot get there, call 999)"),
      ul(["Severe eye pain with nausea/vomiting, sudden severe vision loss, or systemic instability → A&E / 999"]),
      h("Same-day ophthalmic assessment when possible"),
      ul([
        "Progressive eyelid mass, ulceration, bleeding or local lash loss — see an ophthalmologist promptly",
        "New diplopia, limited eye movements or clear proptosis",
        "New adult field loss or unexplained painless vision drop",
        "Childhood leukocoria, new strabismus or sudden change in visual behaviour",
      ]),
      h("What a doctor may discuss / arrange"),
      ul([
        "Slit-lamp, dilated fundus, orbital / ocular ultrasound",
        "When needed: OCT, fluorescein / ICG angiography, MRI / CT by suspected site",
        "Children: complete fundus exam under anaesthesia and team staging",
        "Adult choroidal lesions: size stratification and metastasis-risk discussion (individualised)",
        "Genetic counselling (retinoblastoma and similar)",
      ]),
      h("Common misconceptions"),
      {
        type: "table",
        rows: [
          ["Misconception", "Closer wording"],
          ["“Cancer is only for older people”", "Adults and children have different tumour spectra; childhood leukocoria / strabismus still need careful assessment."],
          ["“No pain means no problem”", "Intraocular tumours can be painless early; warning signs still warrant examination."],
          ["“Early discovery always cures / saves the eye”", "Earlier assessment helps planning; outcomes vary by type and stage — not a guarantee."],
          ["“Eye-sparing treatment is always worse / better than enucleation”", "COMS and related work show comparable survival for certain medium melanomas under either strategy; individual choice is complex."],
          ["“The newest chemotherapy path suits everyone”", "Pathways and indications vary by stage and centre experience; this page does not sell techniques."],
        ],
      },
      note("Public education only — not personal prognosis; does not replace a face-to-face visit. No booking, prescribing or purchasing, and no cure promise. Emergencies: A&E / 999. Childhood warning signs: see also the strabismus and child-vision pages."),
    ],
  },
