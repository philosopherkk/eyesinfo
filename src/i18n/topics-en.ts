...
export const EN_PACKS: Record<string, TopicPack> = {
    ...
    blocks: [
      ...
      p("The ranges below are education-only ballparks; this page’s bibliography (the ESCRS endophthalmitis prophylaxis trial) does not map each row to a percentage. A harder nucleus, trauma, pseudoexfoliation, high myopia, a hypermature lens or combined vitreous surgery raise risk. These figures cannot predict one person, and they are not any clinic’s success rate."),
      {
        ...
        rows: [
          ...
          ["Clinically significant macular oedema", "Not uncommon in the literature; higher with diabetes or capsule rupture; often peaks at 4–6 weeks"],
  ...
  "t-corneal-transplant": {
    ...
    blocks: [
      ...
      p("Donor tissue is foreign to the body; the immune system may mount rejection. The cornea’s relative “immune privilege” means rejection risk is often lower than for some solid organs — but never zero. Aftercare commonly includes:"),
      ul([
  ...
  "t-nystagmus": {
    ...
    blocks: [
      ...
      ul([
        ...
        "Surgery classes: for marked abnormal head posture, extraocular-muscle surgery may be discussed to shift the null zone toward primary position — goals are usually better head posture and functional comfort, not a guarantee of “curing” nystagmus or normalising vision",
      ...
      h("Common misconceptions"),
      {
        ...
        rows: [
          ...
          ["“Surgery always cures it”", "Surgery often improves head posture; the waveform may remain; results vary."],
