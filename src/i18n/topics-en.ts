...
export const EN_PACKS: Record<string, TopicPack> = {
  ...
  "t-presbyopia": {
    ...
    blocks: [
      ...
      h("3. Miotic drops"),
      p("A pinhole effect can ease near work for hours. They do not restore accommodation. Headache, dim night vision and vitreoretinal traction are discussed. Overseas branded presbyopia formulae (e.g. Vuity, Vizz, Yuvezzi) are listed only to say they are not currently registered for retail in Hong Kong. Named-patient import via a registered doctor and a licensed pharmacy is the lawful route. Do not buy online. Check the Drug Office database."),
