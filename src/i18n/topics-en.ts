...
export const EN_PACKS: Record<string, TopicPack> = {
  ...
  "t-strab": {
    ...
    blocks: [
      ...
      h("Go to A&E now (if you cannot get there, see an ophthalmologist as soon as possible)"),
      ul([
  ...
  "t-child": {
    ...
    blocks: [
      p("Rough public-education timing only. Babies start regarding faces in the first weeks. Alignment should settle around 2–3 months. Persistent squint after 3–4 months: assessment by an ophthalmologist the same day if possible. A white pupil (the pupil looking white) or nystagmus at any age: assessment by an ophthalmologist the same day if possible — do not wait and watch at home. Preschool is an important window for amblyopia, strabismus and high refractive error."),
    ],
  },
  "t-cl": {
