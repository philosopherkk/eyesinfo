...
export const EN_PACKS: Record<string, TopicPack> = {
  ...
  "t-rvo": {
    ...
    blocks: [
      ...
      w("Sudden black-out or severe painless loss: go to A&E now. If you cannot get there, see an ophthalmologist as soon as possible. Over fifty with temple pain, jaw claudication or a curtain of vision: exclude giant-cell arteritis the same day. See the giant-cell arteritis page."),
  ...
  "t-gca": {
    ...
    blocks: [
      ...
      ul([
        ...
        "Jaw claudication: jaw fatigue or pain on chewing that eases with rest",
      ...
      p("These are education prompts for describing history at assessment — not an ACR self-score and not a way to “rule out” GCA at home. With or without these clues, any new visual symptom still follows the emergency path."),
      h("Vision red flags: go to A&E now"),
      w("Suspected GCA with any new visual symptom (sudden vision drop, sudden blindness, a field curtain, transient monocular black-out, new double vision): go to A&E now. Do not wait for temporal-artery biopsy or ultrasound scheduling before the urgent path starts. Specialists begin treatment on the A&E / hospital pathway; this page is not a home steroid protocol and has no public dose table."),
      ul([
        "Sudden vision drop or sudden blindness, or a field curtain: go to A&E now (aligned with this site’s urgent page)",
        "Severe pain with headache and vomiting: go to A&E now (also exclude acute angle closure and other emergencies)",
        "If you cannot get there yourself: seek urgent eye care that can manage emergencies as soon as possible; this site does not refer and lists no clinic phones",
      ]),
      ...
      ol([
        ...
        "Steroid-sparing / biologic pathways: where registered, a specialist may discuss interleukin-6 (IL-6) receptor inhibitor class options to reduce long-term steroid burden — not a brand pitch and not a trial scoreboard",
        "Infection, glucose and bone risks: specialists explain monitoring and prevention; this page is not a shopping list for supplements or bisphosphonates",
        "A doctor may discuss low-dose antiplatelet therapy as an accompanying consideration — again not a public milligram schedule",
      ]),
      p("Lost vision is often permanent. The goal of urgent care is to protect remaining vision and the fellow eye, and to control systemic vasculitis. Overlap with retinal artery occlusion is on the retinal vascular occlusion page; the migraine page keeps must-not-miss points."),
      w("This page does not replace face-to-face care or A&E triage. Do not start, adjust or stop systemic steroids yourself. No clinic phones, booking or messaging contacts."),
    ],
  },
  ...
  "t-chem": {
    ...
    meta: "Alkali vs acid · immediate irrigation · specialty staging and class discussion",
    blocks: [
      h("What it is"),
      p("Chemical splash can damage the conjunctiva and cornea within minutes; severe cases reach deeper tissue. This page matches the urgent page: immediate copious irrigation first, then A&E. Public education only — not a home acid–base neutralisation experiment, and not a booking page."),
      h("Alkali and acid (education)"),
      ul([
        ...
        "Exceptions such as hydrofluoric acid are specialty / A&E knowledge: know that exceptions exist; do not self-triage or delay irrigation at home",
      ]),
      h("Do this first: copious irrigation (aligned with the urgent page, expanded)"),
      ol([
      ...
      ul([
        ...
        "Staging ideas (for example Roper-Hall grade, limbal ischaemia): doctor language for prognosis and follow-up — not a self-grading table",
      ]),
      h("After A&E, classes a specialist may discuss (not a public dose menu)"),
      ol([
        "Antibiotic class: to reduce infection risk — prescribed by a doctor; no brand names or times-a-day schedules here",
        "Corticosteroid class: whether and when depends on epithelium and inflammation — specialty timing",
        ...
        "Ascorbate (vitamin C) / citrate as adjunct concepts in selected severe cases — specialty decisions, not supermarket supplements instead of A&E",
      ]),
      p("For severe grades, specialists may discuss amniotic membrane placement/graft and later reconstruction for limbal stem-cell deficiency (LSCD). That is a disease conversation, not a surgery booking menu, and this site does not compare clinics."),
      ...
      p("Surface and dry-eye education sits under Cornea and ocular surface and related topics; pressure and glaucoma under the glaucoma pages. Medicines and surgery after chemical injury follow specialty instructions only."),
      w("Chemical splash: irrigate with lots of water for 20–30 minutes first, go to A&E while irrigating. Sudden vision drop or sudden blindness, or severe pain with headache and vomiting: go to A&E now. No clinic phones, booking or messaging contacts on this page."),
    ],
  },
