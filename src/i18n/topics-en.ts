...
export const EN_PACKS: Record<string, TopicPack> = {
  ...
  "t-cl": {
    ...
    blocks: [
      ...
      h("Microbial keratitis risk (literature ballpark)"),
      {
        type: "table",
        rows: [
          ["Wear pattern", "Ballpark yearly risk per wearer", "Vs daily disposable"],
          ["Daily disposable soft", "About 1/7500–1/10000", "Lower baseline"],
          ["Monthly / reusable soft", "About 1/2500", "Higher than daily disposable"],
          ["Overnight / extended wear", "About 1/500", "About 6–15× daily wear"],
        ],
      },
      p("Figures are published ballparks, not a clinic or brand guarantee. Even lenses labelled for continuous wear still raise infection risk overnight."),
  ...
  "t-lube": {
    ...
    blocks: [
      ...
      p("Multi-dose bottles often contain preservatives (for example BAK-class). Occasional use is tolerated by many. If you use drops more than about four to six times a day, have marked surface disease, are post-op or use many bottles long term, literature often favours preservative-free unit doses or “vanishing” systems. Do not keep an opened unit dose overnight."),
      ...
      ul([
        "Less grit and dryness; intermittent blur after blinking may improve",
        "Tear break-up time may lengthen a little — that is not “cured meibomian glands”",
    ...
    blocks: [
      ...
      h("Anatomical classes (SUN)"),
      {
        ...
        rows: [
          ...
          ["Anterior", "Anterior chamber (iris / ciliary body)", "Most common (~75% of uveitis); some link to HLA-B27 (about 40–50% of anterior cases in the literature)"],
      ...
      ul([
        ...
        "Hypopyon, acute pressure rise, clear corneal opacity, or new eye symptoms while immunosuppressed: same-day ophthalmic specialty care",
  ...
  "t-migraine": {
    ...
    blocks: [
      ...
      h("Retinal migraine"),
      p("A rare diagnosis of temporary monocular vision loss only after embolism, vasospasm and other fundus emergencies are excluded. Sudden monocular blur is not “just migraine” first — seek care on a vascular / fundus pathway."),
