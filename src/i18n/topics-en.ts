...
export const EN_PACKS: Record<string, TopicPack> = {
  ...
  "t-ocular-tumours": {
    ...
    blocks: [
      ...
      note("Public education only — not personal prognosis; does not replace a face-to-face visit. No booking, prescribing or purchasing, and no cure promise. Emergencies: A&E / 999. Childhood warning signs may structurally cross-link to strabismus / child-vision pages."),
    ],
  },
