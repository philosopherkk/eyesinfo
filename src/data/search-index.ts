...
export const SEARCH_SYNONYMS: SearchEntry[] = [
  ...
  },
  {
    id: "t-optic-neuritis",
    kind: "topic",
    href: "/t/t-optic-neuritis",
    titleFallback: "視神經炎：是甚麼、何時求醫與醫生或會討論",
    keywords: [
      "視神經炎",
      "視神經發炎",
      "optic neuritis",
  ...
  },
  {
    ...
    kind: "topic",
    href: "/t/t-corneal-transplant",
    titleFallback: "角膜移植：全層與層狀概念、術後護理與 RSVP",
    keywords: [
      "角膜移植",
      "穿透性角膜移植",
      "板層移植",
  ...
  },
  {
    ...
    kind: "topic",
    href: "/t/t-nystagmus",
    titleFallback: "眼球震顫：嬰幼兒型與後天型、何時求醫",
    keywords: [
      "眼球震顫",
      "眼震",
      "nystagmus",
  ...
  },
  {
    id: "t-ocular-tumours",
    kind: "topic",
    href: "/t/t-ocular-tumours",
    titleFallback: "眼睛腫瘤：眼瞼、眼眶與眼內（公眾教育）",
    keywords: [
      "眼睛腫瘤",
      "眼腫瘤",
      "眼癌",
