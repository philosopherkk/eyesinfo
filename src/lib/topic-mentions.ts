...
const MENTION_ALIASES: MentionLink[] = [
  ...
  { phrase: "他克莫司用於眼瞼", href: "/t/t-tacrolimus-eyelid" },
  ...
  { phrase: "視神經炎", href: "/t/t-optic-neuritis" },
  { phrase: "角膜移植", href: "/t/t-corneal-transplant" },
  { phrase: "眼球震顫", href: "/t/t-nystagmus" },
  { phrase: "眼睛腫瘤", href: "/t/t-ocular-tumours" },
  { phrase: "黃斑裂孔", href: "/t/t-macular-hole" },
  { phrase: "黃斑裂孔專題", href: "/t/t-macular-hole" },
  { phrase: "黃斑前膜", href: "/t/t-erm" },
  { phrase: "黃斑前膜專題", href: "/t/t-erm" },
  { phrase: "視網膜脫離專題", href: "/t/t-rd" },
