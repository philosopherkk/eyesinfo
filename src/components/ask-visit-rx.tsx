...
const SITS_TC = [
  ...
  },
  {
    ...
    qs: [
      ...
      "有無需要散瞳驗光？",
      "戶外時間同近距離習慣點改善？",
      "若討論阿托品或其他光學離焦類方法，係咪處方、有咩副作用要監察？",
      "高度近視要幾耐散瞳眼底一次？",
    ],
  },
] as const;
...
const SITS_EN = [
  {
    ...
    qs: [
      ...
      "Is overnight stay or observation needed after surgery?",
  ...
  },
  {
    ...
    qs: [
      ...
      "If atropine or optical-defocus class options are discussed, is it prescribed and what side effects need monitoring?",
...
const SITS_JA = [
  ...
  },
  {
    ...
    qs: [
      ...
      "散瞳検眼は必要ですか？",
      "屋外時間と近見習慣はどう改善できますか？",
      "アトロピンや光学的デフォーカス類を話す場合、処方ですか、監視すべき副作用は？",
